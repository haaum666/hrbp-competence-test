      ...
      <div className="relative min-h-screen w-full flex flex-col items-center justify-center p-4
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center p-8
          ...
          <p className="text-xl md:text-2xl text-gray-200 max-w-3xl mb-10 leading-relaxed">
            Пройдите наш HRBP-Тест, чтобы оценить свои компетенции в области HR Business Partnering.
            Вы получите подробный отчет о ваших сильных сторонах и областях для развития.
            Тест займет примерно 30 минут и состоит из нескольких секций, охватывающих стратегическое партнерство,
            управление талантами, аналитику данных и организационное развитие. Готовы начать?
          </p>
          
          {/* Кнопка "Начать Тест" УДАЛЕНА */}

          {/* Секция с маршрутами (элемент "Главная страница (текущая)" УДАЛЕН) */}
