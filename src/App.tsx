import { BrowserRouter as Router } from 'react-router-dom'; // Routes и Route больше не нужны, если Routes блок удален
      ...
      <div className="relative min-h-screen w-full flex flex-col items-center justify-center p-4
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center p-8
          ...
          <h1 className="text-6xl md:text-7xl font-extrabold mb-6 tracking-tight drop-shadow-lg"
            ...
            Профессиональный тест для HRBP
          </h1>
          
          {/* Анонс теста (обновленный текст без Markdown-разметки) */}
          <p className="text-xl md:text-2xl text-gray-200 max-w-3xl mb-10 leading-relaxed">
            Ребятушки, я тут совсем угорел по своей работе и начал собирать тест для HRBP.
            <br/><br/>
            Сейчас он на стадии валидации, параллельно собираю web-версию, в течение месяца планирую выпустить в прод.
            <br/>
          ...
          {/* Блок с Routes УДАЛЕН, так как кнопка тоже удалена и пока нет переходов */}
          {/* Если позже понадобятся маршруты, его можно будет добавить обратно */}
