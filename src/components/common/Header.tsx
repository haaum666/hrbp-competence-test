...
          {/* ИКОНКИ TELEGRAM И LINKEDIN (ДОБАВЛЕНЫ ОБРАТНО С УСЛОВНЫМ ОТОБРАЖЕНИЕМ) */}
          <a href="https://t.me/hr_dushnila" target="_blank" rel="noopener noreferrer" className="hidden sm:block transition-colors duration-300 hover:opacity-75">
...
          <a href="https://www.linkedin.com/in/hr-dushnila/" target="_blank" rel="noopener noreferrer" className="hidden sm:block transition-colors duration-300 hover:opacity-75">
