...
      <h1 className="text-3xl sm:text-4xl font-extrabold text-text-primary mb-6">О проекте</h1>
...
        </p>
        <h2 className="text-2xl font-bold text-text-primary mt-6 mb-2">Панель Аналитики</h2>
        <p className="mb-4">
...
        </p>
        <h2 className="text-2xl font-bold text-text-primary mt-6 mb-2">Основные Функциональные Возможности</h2>
...
        <h2 className="text-xl font-bold text-text-primary mb-2">Контакты и поддержка</h2>
