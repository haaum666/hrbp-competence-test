  ...
  return (
    <div className="container mx-auto max-w-4xl px-4 py-8">
      ...
      <div className="text-white text-lg leading-relaxed mb-8">
        <p className="mb-4">
          HRBP-Тест - это инструмент для самооценки и развития компетенций HR Business Partner, разработанный специально для российского рынка труда. Тест структурирован с ориентацией на современные профессиональные стандарты и призван не только помочь в объективной оценке теоретических знаний, но и стать эффективным инструментом для обучения. Подробные объяснения к каждому вопросу, рекомендации по развитию и дополнительные ресурсы превращают процесс тестирования в учебный процесс, помогая глубже понять свою профессию и осваивать новые области.
        </p>
